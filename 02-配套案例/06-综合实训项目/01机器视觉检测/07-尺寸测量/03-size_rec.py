        ...
        for i in self.lab_data:
            ...
            if self.max_area > 2500:  # 有找到最大面积
                ...
                if self.standard_pixel != 0:  # 判断基准像素是否更新
                    ...
                    img = putText(img, "宽:{:.1f}mm\n长:{:.1f}mm".format(width, height),
                                  org=(x, y+10), color=(255, 255, 255))  # 结果绘制
...
if __name__ == "__main__":
    ...
    while True:
        ...
        catframe = size_det.imgRec(catframe, k)
        cv2.imshow("d", catframe)
