...
import time
import numpy as np
from embedded.ArmIK.InverseKinematics import *
# from embedded.HiwonderSDK.Board import setBusServoPulse, getBusServoPulse
...
class ArmIK:
    ...
    def __init__(self):
        ...
        # 设置连杆长度
        self.ik.setLinkLength(L1=self.ik.l1 + 0.75, L4=self.ik.l4 - 0.15)
    ...
    def setPitchRangeMoving(self, coordinate_data, alpha, alpha1, alpha2, movetime=1000):
        ...
        # movetime = self.servosMove((servos["servo3"], servos["servo4"],
...
if __name__ == "__main__":
    ...
    # setBusServoPulse(3, 100, 500)
    # setBusServoPulse(4, 200, 500)
    angle = trans_form.getAngle(100, 100, 45)
    print("angle:", angle)
    # setBusServoPulse(2, angle, 500)

    # AK.setPitchRangeMoving((0, 10, 10), -30, -90, 0, 2000)
    #time.sleep(2)
    AK.setPitchRangeMoving((0, 20, 25), 0, -30, -90, 1500)

    # print(AK.setPitchRangeMoving((0, 20, 25), 0, -90, 0, 2000))
