...
# 在原图中标记这些顶点
cv.circle(img, (int(pts1[0][0]),int(pts1[0][1])), 1, (0, 255, 255), cv.LINE_AA)
cv.circle(img, (int(pts1[1][0]),int(pts1[1][1])), 1, (255, 0, 255), cv.LINE_AA)
cv.circle(img, (int(pts1[2][0]),int(pts1[2][1])), 1, (255, 255, 255), cv.LINE_AA)
cv.circle(img, (int(pts1[3][0]),int(pts1[3][1])), 1, (0, 0, 0), cv.LINE_AA)

# 在目标图中标记顶点
cv.circle(dst, (int(pts2[0][0]),int(pts2[0][1])), 1, (0, 255, 255), cv.LINE_AA)
cv.circle(dst, (int(pts2[1][0]),int(pts2[1][1])), 1, (255, 0, 255), cv.LINE_AA)
cv.circle(dst, (int(pts2[2][0]),int(pts2[2][1])), 1, (255, 255, 255), cv.LINE_AA)
cv.circle(dst, (int(pts2[3][0]),int(pts2[3][1])), 1, (0, 0, 0), cv.LINE_AA)
