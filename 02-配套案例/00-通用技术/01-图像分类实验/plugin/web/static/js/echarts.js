    ...
    function productCharts() {
        ...
        option = {
            ...
            "legend": {
                ...
                "padding": [15, 20],
                "itemGap": 5,
                "data": ["化妆品","生活家电","五谷杂粮","蔬菜水果","熟食","酒水茶饮","粮油","其它",]
            },
            "series": [{
                "type": "pie",
                "center": ["50%", "40%"],
    ...
    function monthChart() {
        ...
        option = {
            ...
            series: [{
                name: '下单量',
                type: 'bar',
                data: [20, 40.0, 70.0, 23.2, 25.6, 76.7, 13.5, 16.2, 32.6, 20.0, 6.4, 3.3],
                itemStyle: {
                    normal: {
                        barBorderRadius: 2
                    }
            ...
            },
                {
                    ...
                    type: 'bar',
                    yAxisIndex: 1,
                    data: [26, 39, 43.40, 24, 27, 7, 16, 22, 47, 18, 16, 23],
                    itemStyle: {
                        normal: {
                            barBorderRadius: 2
                        }
