            ...
            try:
                if self.opened and self.cap.isOpened():
                    ...
                    if ret:
                        ...
                        # 调整图像，进行ROI，获取分拣区域图像
                        frame_resize = frame_tmp[int(frame_tmp.shape[0] / 4.6): int(frame_tmp.shape[0] - frame_tmp.shape[0] / 2.7), int(frame_tmp.shape[1] / 3.4): int(frame_tmp.shape[1] - frame_tmp.shape[1] / 4.5)]
